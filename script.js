...
let currentMono = "Courant Monophasé"
let currentTri = "Courant Triphasé"
let checkbox = document.getElementById("temp");
let phaseDisplay = document.getElementById("currentSelect");
...
checkbox.addEventListener("change", byPassPhase);
...
function calculFormules() {
  ...
  if (tension !== "" && resistance !== "") {
    ...
    document.getElementById("unit").innerText = "Ampères pour l'intensité en mono";
    ...
    document.getElementById("unit").innerText = "Volts pour la tension en mono";
    ...
    document.getElementById("unit").innerText = "Ohms pour la résistance en mono";
  } else {
...
function calculFormule3ph() {
  ...
  if (tension !== "" && resistance !== "") {
    ...
    document.getElementById("result").innerText = calculIntensite.toFixed(2);
    document.getElementById("unit").innerText =
      "Ampères pour l'intensité en tri";
  } else if (intensite !== "" && resistance !== "") {
    ...
    document.getElementById("result").innerText = calculResistance.toFixed(2);
    document.getElementById("unit").innerText =
      "Ohms pour la résistance en tri";
  } else {
    //alert("vous n'avez pas bien rempli le formulaire");
    document.getElementById("unit").innerText = error;
    document.getElementById("unit").style.color = "red";
  ...
  phaseDisplay.innerText = currentTri;
}
